...
TEST_F(OraInstructionTests, oraImm_CanAndWithImmediate) {
    ...
    computer.cpu.A = 0x00;
    computer.memory[0xFFFC] = CPU::oraImm;
...
TEST_F(OraInstructionTests, oraZpg_CanAndFromZeroPage) {
    ...
    computer.cpu.flag.Z = true;
    computer.cpu.A = 0x00;
    computer.memory[0xFFFC] = CPU::oraZpg;
...
TEST_F(OraInstructionTests, oraZpX_CanAndFromZeroPageWithXOffset) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.X = 0x02;
    computer.memory[0xFFFC] = CPU::oraZpX;
    computer.memory[0xFFFD] = 0x80;
...
TEST_F(OraInstructionTests, oraAbs_CanAndFromAbsolute) {
    ...
    computer.cpu.flag.Z = true;
    computer.cpu.A = 0x00;
    computer.memory[0xFFFC] = CPU::oraAbs;
...
TEST_F(OraInstructionTests, oraAbX_CanAndFromAbsoluteX) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.X = 0x02;
    computer.memory[0xFFFC] = CPU::oraAbX;
    computer.memory[0xFFFD] = 0x10;
    computer.memory[0xFFFE] = 0x30;
...
TEST_F(OraInstructionTests, oraAbY_CanAndFromAbsoluteY) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.Y = 0x02;
    computer.memory[0xFFFC] = CPU::oraAbY;
    computer.memory[0xFFFD] = 0x10;
    computer.memory[0xFFFE] = 0x30;
    computer.memory[0x3012] = 0x35;
    const int EXPECTED_CYCLES = 4;
...
TEST_F(OraInstructionTests, oraIdX_CanAndFromIndirectX) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.X = 0x02;
    computer.memory[0xFFFC] = CPU::oraIdX;
    computer.memory[0xFFFD] = 0x80;
...
TEST_F(OraInstructionTests, oraIdY_CanAndFromIndirectY) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.Y = 0x02;
    computer.memory[0xFFFC] = CPU::oraIdY;
    computer.memory[0xFFFD] = 0x80;
