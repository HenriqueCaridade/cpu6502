...
TEST_F(EorInstructionTests, eorImm_CanAndWithImmediate) {
    ...
    computer.cpu.A = 0x00;
    computer.memory[0x1000] = CPU::eorImm;
...
TEST_F(EorInstructionTests, eorZpg_CanAndFromZeroPage) {
    ...
    computer.cpu.flag.Z = true;
    computer.cpu.A = 0x00;
    computer.memory[0x1000] = CPU::eorZpg;
...
TEST_F(EorInstructionTests, eorZpX_CanAndFromZeroPageWithXOffset) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.X = 0x02;
    computer.memory[0x1000] = CPU::eorZpX;
    computer.memory[0x1001] = 0x80;
...
TEST_F(EorInstructionTests, eorAbs_CanAndFromAbsolute) {
    ...
    computer.cpu.flag.Z = true;
    computer.cpu.A = 0x00;
    computer.memory[0x1000] = CPU::eorAbs;
...
TEST_F(EorInstructionTests, eorAbX_CanAndFromAbsoluteX) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.X = 0x02;
    computer.memory[0x1000] = CPU::eorAbX;
    computer.memory[0x1001] = 0x10;
    computer.memory[0x1002] = 0x30;
...
TEST_F(EorInstructionTests, eorAbY_CanAndFromAbsoluteY) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.Y = 0x02;
    computer.memory[0x1000] = CPU::eorAbY;
    computer.memory[0x1001] = 0x10;
    computer.memory[0x1002] = 0x30;
    computer.memory[0x3012] = 0x35;
    const int EXPECTED_CYCLES = 4;
...
TEST_F(EorInstructionTests, eorIdX_CanAndFromIndirectX) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.X = 0x02;
    computer.memory[0x1000] = CPU::eorIdX;
    computer.memory[0x1001] = 0x80;
...
TEST_F(EorInstructionTests, eorIdY_CanAndFromIndirectY) {
    ...
    computer.cpu.A = 0x00;
    computer.cpu.Y = 0x02;
    computer.memory[0x1000] = CPU::eorIdY;
    computer.memory[0x1001] = 0x80;
