...
computer.memory[0xFFFC] = CPU::ldyImm;
...
computer.cpu.flag.N = true;
computer.cpu.flag.Z = true;
computer.memory[0xFFFC] = CPU::ldyZpg;
...
computer.cpu.flag.Z = true;
computer.cpu.X = 0x02;
computer.memory[0xFFFC] = CPU::ldyZpX;
computer.memory[0xFFFD] = 0x80;
...
computer.cpu.flag.N = true;
computer.cpu.flag.Z = true;
computer.memory[0xFFFC] = CPU::ldyAbs;
...
computer.cpu.flag.Z = true;
computer.cpu.X = 0x02;
computer.memory[0xFFFC] = CPU::ldyAbX;
computer.memory[0xFFFD] = 0x10;
computer.memory[0xFFFE] = 0x30;
